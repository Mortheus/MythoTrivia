...
class PhotoScreen(SwipeScreen):
    photo_preview = ObjectProperty(None)

    def __init__(self, **args):
        Builder.load_string(PS)
        super().__init__(**args)
...
class PhotoLayout(BoxLayout):

    def __init__(self, **args):
        Builder.load_string(PL)
        super().__init__(**args)
